export const MESSAGES = {
  UNAUTHORIZED:
    'Тільки зареєстровані користувачі можуть залишати повідомлення. Будь-ласка зайдіть або зареєструйтесь.',
  ...
  USER_BLOCKED: 'Нажаль, ви заблоковані, і ця дія для вас недоступна.',
};
...
export const HELPER_TEXT = {
  ...
  SPOILER_TIP: "Спойлер є обов'язковим полем і може містити максимум 150 символів",
